...
import { Box, Container, Typography, Grid, Paper, Button, Avatar, Stack } from '@mui/material'
        ...
        <Box sx={{ py: 8, backgroundColor: '#ffffff' }}>
            <Container maxWidth='xl'>
                ...
                <Box sx={{ textAlign: 'center', mb: 6 }}>
                    ...
                    >
                        Kami berkomitmen memberikan pengalaman perjalanan terbaik dengan layanan profesional dan harga
                        terjangkau
                    </Typography>
                </Box>
                        ...
                        <Grid item xs={12} sm={6} md={4} key={feature.id}>
                            ...
                            >
                                <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 3 }}>
                                    ...
                                    >
                                        <Icon icon={feature.icon} width={28} height={28} color={feature.color} />
                                    </Paper>
                                    <Box>
                                        <Typography
                                            variant='h6'
